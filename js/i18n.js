...
const UI_STRINGS = {
  ...
  ja: {
    ...
    heroSub: "草月流を学ぶ、フィラデルフィア在住のいけばなデザイナー",
    aboutTitle: "プロフィール",
    aboutP1: "百佳（ベッカ）は2024年から草月流いけばなを学んでいるいけばなデザイナーです。ソーホー・スタディ・グループの一員として、レイチェル・ジョンソン先生に師事し、現在二級の資格を取得しています。サンフランシスコで稽古を始め、現在はフィラデルフィアを拠点に活動しています。",
